---
name: feedback
description: Report a bug or send feedback about the web-scraper plugin
---

# Report web-scraper feedback

File the user's report as a GitHub issue on `tyroneross/blog-content-scraper`. Issues are this plugin's
...
```bash
gh issue create --repo tyroneross/blog-content-scraper \
...
5. If `gh` is missing or unauthenticated, do not fail — print the URL so the user
   can open it in a browser: https://github.com/tyroneross/blog-content-scraper/issues/new
